  ...
  return (
    <>
      <ul
        ...
        {/* <!-- Usuarios --> */}
        <li className= {`nav-item ${location.pathname === '/admin/Usuarios' ? 'active':'' }`}>
        ...
        {/* <!-- PROVEEDOR --> */}
        <li className= {`nav-item ${location.pathname === '/admin/Proveedores' ? 'active':'' }`}>
        ...
        {/* <!-- TALLAS --> */}
        <li className= {`nav-item ${location.pathname === '/admin/Tallas' ? 'active':'' }`}>
        ...
        {/* <!-- COMPRAS --> */}
        <li className= {`nav-item ${location.pathname === '/admin/Compras' ? 'active':'' }`}>
        ...
        {/* <!-- PRODUCTOS --> */}
        <li className= {`nav-item ${location.pathname === '/admin/Productos' ? 'active':'' }`}>
        ...
        {/* <!-- DISEÑOS --> */}
        <li className= {`nav-item ${location.pathname === '/admin/Disenios' ? 'active':'' }`}>
        ...
        {/* <!-- Clientes --> */}
        <li className= {`nav-item ${location.pathname === '/admin/Clientes' ? 'active':'' }`}>
        ...
        {/* <!-- VENTAS --> */}
        <li className= {`nav-item ${location.pathname === '/admin/Ventas' ? 'active':'' }`}>
        ...
        {/* <!-- PEDIDOS --> */}
        <li className= {`nav-item ${location.pathname === '/admin/Pedidos' ? 'active':'' }`}>
          <Link to={"/admin/Pedidos"} className="nav-link" href="Pedidos.html">
