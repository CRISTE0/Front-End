          ...
          <div className="modal-dialog" role="document">
            <div className="modal-content">
              <div className="modal-header">
                <h5 className="modal-title" id="ModalAñadirVenta">Crear Pedido</h5>
              ...
              <div className="modal-body">
                ...
                <form id="crearVentaForm">
                  ...
                  <div className="form-group d-flex justify-content-center">
                    {/* <button type="button" className="btn btn-primary" onClick={{"crearTabla()"}}>Añadir Producto</button> */}
                  </div>
          ...
          <div className="d-flex align-items-center justify-content-between">
            ...
            <div className="text-center p-3">
              <button type="button" className="btn btn-dark" data-toggle="modal" data-target="#ModalCrearVenta">
                <i className="fas fa-pencil-alt"></i> Crear Pedido
              </button>
            </div>
          </div>
            ...
            <div className="modal-dialog" role="document">
              <div className="modal-content">
                ...
                <div className="modal-body">
                  ...
                  <div className="form-group">
                    <label htmlFor="fechaVenta" style={{color: "black"}}>Fecha del pedido:</label>
                  ...
                  <div className="form-group">
                    <label htmlFor="detallesVenta" style={{color: "black"}}>Detalles del pedido:</label>
